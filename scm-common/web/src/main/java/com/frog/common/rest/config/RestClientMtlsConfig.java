 ...
 * 替代 OpenFeign 的 FeignMtlsConfig
 *
 * <p>特性：
 * <ul>
...
public class RestClientMtlsConfig {
    ...
    /**
     * 配置 SSL Bundle（推荐方式）
     * <p>使用 Spring Boot 4.0 的 SSL Bundle 机制，支持证书热更新</p>
     */
    @Bean
    ...
    public ClientHttpRequestFactory clientHttpRequestFactory(SslBundle sslBundle) {
        ...
        // 从 SSL Bundle 创建 SSLContext
        SSLContext sslContext = sslBundle.createSslContext();

        // 使用 JDK 21 的 HttpClient（支持虚拟线程）
