...
public class SeataAtModeIntegrationTest {
    ...
    public void setup() {
        ...
        log.info("�初始化库� SKU={}, 可用库存=100", TEST_SKU_ID);
    }

    /**
     * 场景 1: 订单创建成功，库存充��全局事务提交
     */
    @Test
    ...
    public void testCreateOrderSuccess_CommitTransaction() {
        ...
        assertEquals(90, inventoryInDb.getAvailableStock(), "可用库存应该扣减 10�00 - 10 = 90�);
    ...
    public void testCreateOrderFailed_InsufficientStock_RollbackTransaction() {
        ...
        assertTrue(exception.getMessage().contains("库存不足"), "异常信息应包�库存不足'");
