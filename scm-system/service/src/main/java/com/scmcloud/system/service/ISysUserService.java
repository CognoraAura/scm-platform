...
public interface ISysUserService extends IService<SysUser> {
     ...
     * @param status   用户状态（可选，如：0-禁用�-启用�
     * @return 用户分页数据
     */
     ...
     *
     * @param username 用户�
     * @return SecurityUser 用于认证的用户对象，包含密码、角色、权限等信息；如果用户不存在则返�null
     */
     ...
     *
     * @param userId 用户 ID
     * @return 数据范围标识（例如：0-仅本人，1-本部门，2-本部门及以下�-全部等）
     */
